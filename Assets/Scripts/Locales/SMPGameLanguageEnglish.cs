...
public partial class SMPGameLanguage
{
	private void SetLanguageToEnglish()
	{
		...
		home_needHelp = "Need help?";

		menu_setting = "settings";
		setting_soundFx = "Sound";
		setting_soundMusic = "Music";
		setting_fairy_ads = "Flucky bird ads";
		setting_login = "Sign up through Facebook";
		setting_logout = "Logout Facebook";
		setting_language_name = "ENGLISH";
		...
		inventory_bt_levelup = "LEVEL UP";
		inventory_bt_buy = "BUY";
		inventory_bt_max = "MAX";
		inventory_txt_max = "MAXIMUM";
		...
		skill_description[6] = "Activate pets revenge";
		skill_description[7] = "Ativate shield to protect hero";
		skill_description[8] = "Activate supports fly";
		skill_description[9] = "Decrease monsters by stage by [-N]";
		...
		achm_item_title[8] = "Use Thunder attack [N] times";
		achm_item_title[9] = "Reach [N] stages";
		achm_item_title[10] = "Get [N] Critical Hits";
		achm_item_title[11] = "Use [N] Doom skill";

		achm_item_title[12] = "Account Connected";
		achm_item_title[13] = "Kill [N] Ghost";
		achm_item_title[14] = "Kill [N] Mini Boss";
		achm_item_title[15] = "Unlock [N] Heroes";
		...
		support_all_supporter_dps = "All Fellows DPS";
		support_skill_evolve = "Evolve";
		support_skill_icon_unlock = "Unlock";
		support_active_title = "Active Fellows";
		support_flying_title = "Flying Fellows";
		support_passive_title = "Passive Fellows";
		...
		support_skill_type_descriptions[10] = "Increase mana refil rate [+n]"; //ex: +1
		SetENGSupportInfo();
		...
		pls_bt_leave_battle = "LEAVE BATTLE";
		pls_bt_fight_boss = "FIGHT BOSS";
		pls_failed_to_fight_boss = "Failed to fight the boss";
		...
		account_creation_text_des = "Your legend begins here, take your courage and your weapon and embark on the greatest adventure of your life.";
		account_creation_text_reward = "Sign up to save your progress and get reward 100";
		account_creation_sign_in_with_apple = "Sign in with Apple";
		account_creation_sign_in_with_facebook = "Sign in with Facebook";
		account_creation_logout = "LOGOUT";
		account_creation_save = "SAVE";
		account_creation_text_name = "NAME:";
		account_creation_text_name_place_holder = "Type your warrior name...";
		account_creation_text_avatar = "ETHOS:";
		account_creation_text_avatar_des = "Your Ethos and name will be displayed in online multiplayers features like clan, quest and tournaments...";
		...
		loading_required_assets = "Preparing the battle ... ";
		checking_required_assets = "Checking required assets ... ";
		loading = "Preparing ...";
		starting_game = "Starting the battle ...";
...
#if UNITY_ANDROID
		sharemail_subject = "Android Game: Frant's garden. Check it out!";
#else
		sharemail_subject						= "iOS Game: Frant's garden. Check it out!";
#endif
		...
		moregame_button = "More Game";
		txt_display_format = "Scentific";
		...
		leaderboard_des = "All your achievements progress or diamonds reward are here. Please enjoy and collect may rewards!!";
		leaderboard_action_menu1 = "THIS HOURS";
		leaderboard_action_menu2 = "LAST 24 HOURS";
		leaderboard_action_menu3 = "LAST WEEK";
		leaderboard_action_menu4 = "ALL TIME";
		leaderboard_text_rank = "RANK";
		leaderboard_text_name = "NAME";
		leaderboard_text_country = "COUNTRY";
		leaderboard_text_level = "LEVEL";
		leaderboard_text_no_item = "Currently, there is no item.";
	...
	private void SetENGProgressTitle ()
	{
	...
	private void SetENGProgressDes ()
	{
	...
	private void SetENGSupportInfo()
	{
		supporters_info[0].name = "Sena";
		supporters_info[0].skill_names[0] = "Crown of fire";
		supporters_info[0].skill_names[1] = "Barrière de feu";
		supporters_info[0].skill_names[2] = "Stone of fire";
		supporters_info[0].skill_names[3] = "Mana Bonus";
		supporters_info[0].skill_names[4] = "Wave of fire";
		supporters_info[0].skill_names[5] = "Electric striking";
		supporters_info[0].skill_names[6] = "Makeshift veil";
		supporters_info[0].skill_names[7] = "The Runeblade";
		supporters_info[0].skill_names[8] = "Evolve";

		supporters_info[1].name = "Vorana";
		supporters_info[1].skill_names[0] = "Dragon's fire";
		supporters_info[1].skill_names[1] = "Necromancer";
		supporters_info[1].skill_names[2] = "Star ravager";
		supporters_info[1].skill_names[3] = "Devil's mark";
		supporters_info[1].skill_names[4] = "Dragon mouth";
		supporters_info[1].skill_names[5] = "Darkness hole";
		supporters_info[1].skill_names[6] = "the wave of fear";
		supporters_info[1].skill_names[7] = "Death bombing";
		supporters_info[1].skill_names[8] = "Evolve";

		supporters_info[2].name = "Chao Cheum";
		supporters_info[2].skill_names[0] = "triplet Strength";
		supporters_info[2].skill_names[1] = "Snake lightning";
		supporters_info[2].skill_names[2] = "Queen netting";
		supporters_info[2].skill_names[3] = "Lightning arrow";
		supporters_info[2].skill_names[4] = "Mana Bonus";
		supporters_info[2].skill_names[5] = "Oeil du cyclone";
		supporters_info[2].skill_names[6] = "Spirit lightning";
		supporters_info[2].skill_names[7] = "Ice breaker";
		supporters_info[2].skill_names[8] = "Evolve";

		supporters_info[3].name = "Kakei";
		supporters_info[3].skill_names[0] = "Meteor rain";
		supporters_info[3].skill_names[1] = "Lightning burst";
		supporters_info[3].skill_names[2] = "Lost Soul Book";
		supporters_info[3].skill_names[3] = "Helmet of Garuda";
		supporters_info[3].skill_names[4] = "Mana Bonus";
		supporters_info[3].skill_names[5] = "Hammer of light";
		supporters_info[3].skill_names[6] = "Arrow of clarity";
		supporters_info[3].skill_names[7] = "Molgur Skull";
		supporters_info[3].skill_names[8] = "Evolve";

		supporters_info[4].name = "Reachboth";
		supporters_info[4].skill_names[0] = "Damnation's fire";
		supporters_info[4].skill_names[1] = "Madness king";
		supporters_info[4].skill_names[2] = "Bloody fist";
		supporters_info[4].skill_names[3] = "Midas's Medallion";
		supporters_info[4].skill_names[4] = "Luck runes";
		supporters_info[4].skill_names[5] = "Mana Bonus";
		supporters_info[4].skill_names[6] = "Essence of loyalty";
		supporters_info[4].skill_names[7] = "Beast's mouth";
		supporters_info[4].skill_names[8] = "Evolve";

		supporters_info[5].name = "Kola";
		supporters_info[5].skill_names[0] = "Executioner's sword";
		supporters_info[5].skill_names[1] = "Claw of darkness";
		supporters_info[5].skill_names[2] = "Skull of Despair";
		supporters_info[5].skill_names[3] = "tatterdemalion";
		supporters_info[5].skill_names[4] = "Anger flame";
		supporters_info[5].skill_names[5] = "Mana Bonus";
		supporters_info[5].skill_names[6] = "Garazorh force";
		supporters_info[5].skill_names[7] = "Eporann's frightenen";
		supporters_info[5].skill_names[8] = "Evolve";

		supporters_info[6].name = "Chhorda";
		supporters_info[6].skill_names[0] = "Nebulous spirit";
		supporters_info[6].skill_names[1] = "Wave of rebellion";
		supporters_info[6].skill_names[2] = "Silver chaos";
		supporters_info[6].skill_names[3] = "Nebulous eye";
		supporters_info[6].skill_names[4] = "Paw of the beast";
		supporters_info[6].skill_names[5] = "Explosion of soul";
		supporters_info[6].skill_names[6] = "Mana Bonus";
		supporters_info[6].skill_names[7] = "Brouillard d'âme";
		supporters_info[6].skill_names[8] = "Evolve";

		supporters_info[7].name = "Mala";
		supporters_info[7].skill_names[0] = "Hammer of justice";
		supporters_info[7].skill_names[1] = "Devilish flamme";
		supporters_info[7].skill_names[2] = "Skull's fire";
		supporters_info[7].skill_names[3] = "Claws of fire";
		supporters_info[7].skill_names[4] = "Enlighted skeleton";
		supporters_info[7].skill_names[5] = "Beast of luck";
		supporters_info[7].skill_names[6] = "Épée enflammée";
		supporters_info[7].skill_names[7] = "Evolve";

		supporters_info[8].name = "Botom";
		supporters_info[8].skill_names[0] = "Scroll of Power";
		supporters_info[8].skill_names[1] = "Golden runes";
		supporters_info[8].skill_names[2] = "Hand of god";
		supporters_info[8].skill_names[3] = "Book of gold";
		supporters_info[8].skill_names[4] = "Nemesis skull";
		supporters_info[8].skill_names[5] = "Savior sword";
		supporters_info[8].skill_names[6] = "the wave of fear";
		supporters_info[8].skill_names[7] = "Cannibal plant";
		supporters_info[8].skill_names[8] = "Evolve";

		supporters_info[9].name = "Neang Romsai Sork";
		supporters_info[9].skill_names[0] = "Universe eye";
		supporters_info[9].skill_names[1] = "Souls ebullition";
		supporters_info[9].skill_names[2] = "Tornado spirit";
		supporters_info[9].skill_names[3] = "Emanation Veil";
		supporters_info[9].skill_names[4] = "Cold fire";
		supporters_info[9].skill_names[5] = "Mhanaan's madness";
		supporters_info[9].skill_names[6] = "Pragaan's fortune";
		supporters_info[9].skill_names[7] = "Evolve";

		supporters_info[10].name = "Kamov";
		supporters_info[10].skill_names[0] = "Twin sword";
		supporters_info[10].skill_names[1] = "Parchemin de chance";
		supporters_info[10].skill_names[2] = "Amphore des ancien";
		supporters_info[10].skill_names[3] = "Spirit fire";
		supporters_info[10].skill_names[4] = "Cat spirit";
		supporters_info[10].skill_names[5] = "Phoenix claw";
		supporters_info[10].skill_names[6] = "Shield guardian";
		supporters_info[10].skill_names[7] = "Evolve";

		supporters_info[11].name = "Angulimear";
		supporters_info[11].skill_names[0] = "Bloody sword";
		supporters_info[11].skill_names[1] = "Bloody rain";
		supporters_info[11].skill_names[2] = "Arrow of death";
		supporters_info[11].skill_names[3] = "golden enchantment";
		supporters_info[11].skill_names[4] = "Claw of the lynx";
		supporters_info[11].skill_names[5] = "Bloody axe";
		supporters_info[11].skill_names[6] = "bloody whirlwind";
		supporters_info[11].skill_names[7] = "Evolve";

		supporters_info[12].name = "Machar";
		supporters_info[12].skill_names[0] = "Garanoor's breath";
		supporters_info[12].skill_names[1] = "Perpetual storm";
		supporters_info[12].skill_names[2] = "Bane of the elves";
		supporters_info[12].skill_names[3] = "Mana Bonus";
		supporters_info[12].skill_names[4] = "Plague's arrow";
		supporters_info[12].skill_names[5] = "sheath of banished";
		supporters_info[12].skill_names[6] = "Savage cat";
		supporters_info[12].skill_names[7] = "enchanted arrowhead";
		supporters_info[12].skill_names[8] = "Evolve";

		supporters_info[13].name = "Neang Phan";
		supporters_info[13].skill_names[0] = "Fear's paw";
		supporters_info[13].skill_names[1] = "Gerahmer's Hammer ";
		supporters_info[13].skill_names[2] = "Faith of demon";
		supporters_info[13].skill_names[3] = "Peaceful lightning";
		supporters_info[13].skill_names[4] = "Mana Bonus";
		supporters_info[13].skill_names[5] = "Celestial bird";
		supporters_info[13].skill_names[6] = "Armored fist";
		supporters_info[13].skill_names[7] = "Arganoor helmet";
		supporters_info[13].skill_names[8] = "Evolve";

		supporters_info[14].name = "Tida";
		supporters_info[14].skill_names[0] = "Heart stamina";
		supporters_info[14].skill_names[1] = "Heart's scar";
		supporters_info[14].skill_names[2] = "Blood fire";
		supporters_info[14].skill_names[3] = "Midas's hair";
		supporters_info[14].skill_names[4] = "Hell's canines";
		supporters_info[14].skill_names[5] = "Mana Bonus";
		supporters_info[14].skill_names[6] = "Woe's skeleton";
		supporters_info[14].skill_names[7] = "Warrior's axe";
		supporters_info[14].skill_names[8] = "Evolve";

		supporters_info[15].name = "Chey";
		supporters_info[15].skill_names[0] = "Breath of God";
		supporters_info[15].skill_names[1] = "Hammer of Hephaestus";
		supporters_info[15].skill_names[2] = "Cloaked nebula";
		supporters_info[15].skill_names[3] = "Stone of darkness";
		supporters_info[15].skill_names[4] = "Mythical portal";
		supporters_info[15].skill_names[5] = "Eye of Gaorona";
		supporters_info[15].skill_names[6] = "Mana Bonus";
		supporters_info[15].skill_names[7] = "Sword of destiny";
		supporters_info[15].skill_names[8] = "Evolve";

		supporters_info[16].name = "Angk Tep";
		supporters_info[16].skill_names[0] = "Monkey king spirit";
		supporters_info[16].skill_names[1] = "Ghost Skull";
		supporters_info[16].skill_names[2] = "Lightning nova";
		supporters_info[16].skill_names[3] = "Nova invocation";
		supporters_info[16].skill_names[4] = "Lightning of gods";
		supporters_info[16].skill_names[5] = "Golden Crown";
		supporters_info[16].skill_names[6] = "Wave of fear";
		supporters_info[16].skill_names[7] = "legendary beast";
		supporters_info[16].skill_names[8] = "Evolve";

		supporters_info[17].name = "Terah Mara";
		supporters_info[17].skill_names[0] = "Righteous impetus";
		supporters_info[17].skill_names[1] = "Blood beings";
		supporters_info[17].skill_names[2] = "Vitality's drop";
		supporters_info[17].skill_names[3] = "Maw of death";
		supporters_info[17].skill_names[4] = "Mana Bonus";
		supporters_info[17].skill_names[5] = "Poisonous rain";
		supporters_info[17].skill_names[6] = "Axe of fortitude";
		supporters_info[17].skill_names[7] = "Gragooth jaw";
		supporters_info[17].skill_names[8] = "Evolve";

		supporters_info[18].name = "Terah Meura";
		supporters_info[18].skill_names[0] = "Strength draining";
		supporters_info[18].skill_names[1] = "Magic swell";
		supporters_info[18].skill_names[2] = "Purple crystal";
		supporters_info[18].skill_names[3] = "Menothos's skull";
		supporters_info[18].skill_names[4] = "Witchery swipe";
		supporters_info[18].skill_names[5] = "Mana Bonus";
		supporters_info[18].skill_names[6] = "Witchcraft eye";
		supporters_info[18].skill_names[7] = "Falling star";
		supporters_info[18].skill_names[8] = "Evolve";

		supporters_info[19].name = "Angk Piseth";
		supporters_info[19].skill_names[0] = "Ruthless rain";
		supporters_info[19].skill_names[1] = "Perfect strike";
		supporters_info[19].skill_names[2] = "The anger lightning";
		supporters_info[19].skill_names[3] = "Devilish lightning";
		supporters_info[19].skill_names[4] = "Peaceful gateway ";
		supporters_info[19].skill_names[5] = "Leaf of luck";
		supporters_info[19].skill_names[6] = "Celestial way";
		supporters_info[19].skill_names[7] = "Evolve";
	}
}
